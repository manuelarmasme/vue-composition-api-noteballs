<template>
  <div class="auth container is-max-desktop px-2 py-4">
      ...
      <div class="card-content">
        ...
        >
          ...
          <div class="field is-grouped is-grouped-right">
            <p class="control">
              <button @click.prevent="onSubmit" class="button is-primary">
                {{formTitle}}
              </button>
            </p>
          </div>
...
<script setup>
  ...
  const onSubmit =  ()=>{
    if(!credentials.email || !credentials.password){
      ...
      register.value ? storeAuth.registerUser(credentials)
